...
@Api(tags = "Inventory",value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_CONTROLLER_NAME, description = InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_CONTROLLER_DESCRIPTION)
public class ProductAttributeValueController {

    @Autowired
    MqttSubscribePublished mqttSubscribePublished;

    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_SAVE_SERVICE_LINK_DESCRIPTION, response = ProductAttributeValueModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            ...
            responseMessage = mqttSubscribePublished.getResponseMessage(InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_BASE_URL+InventoryModuleConstant.SAVE_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_DELETE_SERVICE_LINK_DESCRIPTION, response = ProductAttributeValueModel.class)
    ...
    public ResponseMessage delete(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_INVENTORY_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_INVENTORY_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_BASE_URL+InventoryModuleConstant.DELETE_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
    ...
    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_SEARCH_SERVICE_LINK_DESCRIPTION, response = ProductAttributeValueModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_INVENTORY_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_INVENTORY_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_BASE_URL+InventoryModuleConstant.SEARCH_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
    ...
    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_INACTIVE_SERVICE_LINK_DESCRIPTION, response = ProductAttributeValueModel.class)
    ...
    public ResponseMessage inactive(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_INVENTORY_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_INVENTORY_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(InventoryModuleConstant.PRODUCT_ATTRIBUTE_VALUE_BASE_URL+InventoryModuleConstant.INACTIVE_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
