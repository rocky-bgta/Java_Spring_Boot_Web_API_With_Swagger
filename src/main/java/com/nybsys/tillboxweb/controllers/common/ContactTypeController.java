...
public class ContactTypeController {
    ...
    @ApiOperation(value = CommonModuleConstant.CONTACT_TYPE_SAVE_SERVICE_LINK_DESCRIPTION, response = ContactTypeModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            ...
            responseMessage = mqttSubscribePublished.getResponseMessage(CommonModuleConstant.CONTACT_TYPE_BASE_URL+CommonModuleConstant.SAVE_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @ApiOperation(value = CommonModuleConstant.CONTACT_TYPE_SEARCH_SERVICE_LINK_DESCRIPTION, response = ContactTypeModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_COMMON_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_COMMON_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(CommonModuleConstant.CONTACT_TYPE_BASE_URL+CommonModuleConstant.SEARCH_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
    ...
    @ApiOperation(value = CommonModuleConstant.CONTACT_TYPE_GET_BY_ID_SERVICE_LINK_DESCRIPTION, response = ContactTypeModel.class)
    ...
    public ResponseMessage delete(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_COMMON_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_COMMON_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(CommonModuleConstant.CONTACT_TYPE_BASE_URL+CommonModuleConstant.GET_BY_ID_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
