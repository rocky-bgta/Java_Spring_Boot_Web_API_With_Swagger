...
@RestController
@RequestMapping(UserRegistrationModuleConstant.BUSINESS_DETAILS_BASE_URL)
@Api(tags = "User-Registration",value = UserRegistrationModuleConstant.BUSINESS_DETAILS_CONTROLLER_DESCRIPTION, description = UserRegistrationModuleConstant.BUSINESS_DETAILS_CONTROLLER_DESCRIPTION)
public class BusinessDetailsController {
    ...
    @ApiOperation(value = UserRegistrationModuleConstant.BUSINESS_DETAILS_SAVE_SERVICE_LINK_DESCRIPTION, response = VMBusinessDetail.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            ...
            responseMessage = mqttSubscribePublished.getResponseMessage(UserRegistrationModuleConstant.BUSINESS_DETAILS_BASE_URL+UserRegistrationModuleConstant.SAVE_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @ApiOperation(value = UserRegistrationModuleConstant.BUSINESS_DETAILS_GET_BY_ID_SERVICE_LINK_DESCRIPTION, response = BusinessDetailsModel.class)
    ...
    public ResponseMessage getByID(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_USER_REGISTRATION_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_USER_REGISTRATION_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(UserRegistrationModuleConstant.BUSINESS_DETAILS_BASE_URL+UserRegistrationModuleConstant.GET_BY_ID_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
    ...
    @ApiOperation(value = UserRegistrationModuleConstant.BUSINESS_DETAILS_SEARCH_SERVICE_LINK_DESCRIPTION, response = BusinessDetailsModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_USER_REGISTRATION_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_USER_REGISTRATION_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(UserRegistrationModuleConstant.BUSINESS_DETAILS_BASE_URL+UserRegistrationModuleConstant.SEARCH_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
