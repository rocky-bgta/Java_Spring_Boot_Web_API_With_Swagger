...
@RestController
@RequestMapping(UserRegistrationModuleConstant.VAT_RATE_BASE_URL)
@Api(tags = "User-Registration",value = UserRegistrationModuleConstant.VAT_RATE_CONTROLLER_NAME, description = UserRegistrationModuleConstant.BUSINESS_CONTACT_CONTROLLER_DESCRIPTION)
public class VATRateController {
    ...
    @ApiOperation(value = UserRegistrationModuleConstant.VAT_RATE_SEARCH_LINK_DESCRIPTION, response = VATRateModel.class)
