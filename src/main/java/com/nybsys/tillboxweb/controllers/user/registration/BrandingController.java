...
@RestController
@RequestMapping(UserRegistrationModuleConstant.BRANDING_BASE_URL)
@Api(tags = "User-Registration",value = UserRegistrationModuleConstant.BRANDING_CONTROLLER_NAME, description = UserRegistrationModuleConstant.BRANDING_CONTROLLER_DESCRIPTION)
public class BrandingController {

    @Autowired
    MqttSubscribePublished mqttSubscribePublished;

    @ApiOperation(value = UserRegistrationModuleConstant.BRANDING_SAVE_SERVICE_LINK_DESCRIPTION, response = BrandingModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            ...
            responseMessage = mqttSubscribePublished.getResponseMessage(UserRegistrationModuleConstant.BRANDING_BASE_URL+UserRegistrationModuleConstant.SAVE_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @ApiOperation(value = UserRegistrationModuleConstant.BRANDING_SEARCH_SERVICE_LINK_DESCRIPTION, response = BrandingModel.class)
    ...
    public ResponseMessage getByBusiness(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_USER_REGISTRATION_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_USER_REGISTRATION_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(UserRegistrationModuleConstant.BRANDING_BASE_URL+UserRegistrationModuleConstant.SEARCH_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
