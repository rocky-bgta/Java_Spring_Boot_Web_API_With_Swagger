...
@RestController
@RequestMapping(UserRegistrationModuleConstant.STATEMENT_MESSAGE_BASE_URL)
@Api(tags = "User-Registration", value = UserRegistrationModuleConstant.STATEMENT_MESSAGE_CONTROLLER_NAME, description = UserRegistrationModuleConstant.BUSINESS_CONTACT_CONTROLLER_DESCRIPTION)
public class StatementMessageController {

    @Autowired
    MqttSubscribePublished mqttSubscribePublished;

    @ApiOperation(value = UserRegistrationModuleConstant.STATEMENT_MESSAGE_SAVE_SERVICE_LINK_DESCRIPTION, response = VMStatementMessage.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            ...
            responseMessage = mqttSubscribePublished.getResponseMessage(UserRegistrationModuleConstant.STATEMENT_MESSAGE_BASE_URL + UserRegistrationModuleConstant.SAVE_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @ApiOperation(value = UserRegistrationModuleConstant.STATEMENT_MESSAGE_SEARCH_LINK_DESCRIPTION, response = StatementMessageModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        try {
            this.mqttSubscribePublished.setSubscriptionTopic(WEB_API_USER_REGISTRATION_TOPIC);
            this.mqttSubscribePublished.setPublishedTopic(WORKER_USER_REGISTRATION_MODULE_TOPIC);
            responseMessage = mqttSubscribePublished.getResponseMessage(UserRegistrationModuleConstant.STATEMENT_MESSAGE_BASE_URL + UserRegistrationModuleConstant.SEARCH_SERVICE_LINK, requestMessage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return responseMessage;
